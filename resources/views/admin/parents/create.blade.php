                ...
                <div class="col-md-8 mb-4">
                    ...
                    <div class="card card-cascade cascading-admin-card user-card">
                        ...
                        <div class="admin-up d-flex justify-content-start">
                            ...
                            <div class="data">
                                <h5 class="font-weight-bold dark-grey-text">Tambah Profil Penjaga - <span class="text-muted">Sila pastikan semua ruangan diisi</span></h5>
                            </div>
                        </div>
                        <!--/.Card Data-->

                        <!-- Form -->
                        <form method="post" action="{{route('admin.parent.store')}}">
                            @csrf
                            <!--Card content-->
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="md-form form-sm">
                                            <input type="text" name="icnumber" id="icnumber" class="form-control form-control-sm" value="{{old('icnumber')}}" required>
                                        ...
                                        <div class="md-form form-sm">
    										...
    										<select class="mdb-select colorful-select dropdown-primary" name="race" id="race" required>
    											...
    											@foreach($races as $race)
    											    <option value="{{$race->race_id}}" {{old('race') == $race->race_id ? 'selected' : ''}}>{{$race->name}}</option>
    										    @endforeach
                                        ...
                                        <div class="md-form form-sm">
    										...
    										<select class="mdb-select colorful-select dropdown-primary" name="religion" id="religion" required>
    											...
    											@foreach($religions as $religion)
    												<option value="{{$religion->religion_id}}" {{old('religion') == $religion->religion_id ? 'selected' : ''}}>{{$religion->name}}</option>
    											@endforeach
                                        ...
                                        <div class="md-form form-sm">
    										...
    										<select class="mdb-select colorful-select dropdown-primary" name="education" id="education" required>
    											...
    											@foreach($educations as $education)
    												<option value="{{$education->education_id}}" {{old('education') == $education->education_id ? 'selected' : ''}}>{{$education->name}}</option>
    											@endforeach
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="md-form form-sm">
                                            <input type="text" name="email" id="email" class="form-control form-control-sm" value="{{old('email')}}" required>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="md-form form-sm">
                                            <input type="text" name="phoneNo" id="phoneNo" class="form-control form-control-sm" value="{{old('phoneNo')}}" required>
                                ...
                                <div class="row pb-5">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="md-form form-sm">
                                            <input type="text" name="profession" id="profession" class="form-control form-control-sm" value="{{old('profession')}}" required>
                                        ...
                                        <div class="md-form form-sm">
                                            ...
                                            <select class="mdb-select colorful-select dropdown-primary" name="income" id="income" required>
                                                ...
                                                @foreach($incomes as $income)
                                                    <option value="{{$income->income_id}}" {{old('income') == $income->income_id ? 'selected' : ''}}>{{$income->name}}</option>
                                                @endforeach
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="md-form form-sm">
                                            <input type="text" name="mother_icnumber" id="mother_icnumber" class="form-control form-control-sm" value="{{old('mother_icnumber')}}">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="md-form form-sm">
                                            ...
                                            <select class="mdb-select colorful-select dropdown-primary" name="mother_race" id="mother_race">
                                                ...
                                                @foreach($races as $race)
                                                    <option value="{{$race->race_id}}" {{old('mother_race') == $race->race_id ? 'selected' : ''}}>{{$race->name}}</option>
                                                @endforeach
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="md-form form-sm">
                                            ...
                                            <select class="mdb-select colorful-select dropdown-primary" name="mother_religion" id="mother_religion">
                                                ...
                                                @foreach($religions as $religion)
                                                    <option value="{{$religion->religion_id}}" {{old('mother_religion') == $religion->religion_id ? 'selected' : ''}}>{{$religion->name}}</option>
                                                @endforeach
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="md-form form-sm">
                                            ...
                                            <select class="mdb-select colorful-select dropdown-primary" name="mother_education" id="mother_education">
                                                ...
                                                @foreach($educations as $education)
                                                    <option value="{{$education->education_id}}" {{old('mother_education') == $education->education_id ? 'selected' : ''}}>{{$education->name}}</option>
                                                @endforeach
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="md-form form-sm">
                                            <input type="text" name="mother_email" id="mother_email" class="form-control form-control-sm" value="{{old('mother_email')}}">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="md-form form-sm">
                                            <input type="text" name="mother_phoneNo" id="mother_phoneNo" class="form-control form-control-sm" value="{{old('mother_phoneNo')}}">
                                ...
                                <div class="row pb-4">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="md-form form-sm">
                                            <input type="text" name="mother_profession" id="mother_profession" class="form-control form-control-sm" value="{{old('mother_profession')}}">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="md-form form-sm">
                                            ...
                                            <select class="mdb-select colorful-select dropdown-primary" name="mother_income" id="mother_income">
                                                ...
                                                @foreach($incomes as $income)
                                                    <option value="{{$income->income_id}}" {{old('mother_income') == $income->income_id ? 'selected' : ''}}>{{$income->name}}</option>
                                                @endforeach
                                ...
                                <div class="row">
                            	  	<div class="col-lg-12 col-md-12 text-right pt-5">
                                        ...
                                        <a href="{{route('admin.parent.index')}}"><button type="button" class="btn btn-flat grey lighten-3 btn-rounded waves-effect font-weight-bold dark-grey-text">Kembali</button></a>
                                	</div>	
