...
@section("sidebar")
    @include("components.navigations.sidebar", ["active" =>"students"])
@endsection
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-6 col-xs-6 text-left pb-3">
			<h4 class="text-white pt-2"><span class="fa fa-list mr-1"></span> Senarai Pelajar </h4>
		</div>
		{{-- <div class="col-md-6 col-xs-6 text-right pb-3">
			<a href="{{route('admin.student.create')}}"><button type="button" class="btn btn-success ">Tambah Maklumat</button></a>
	...
	<div class="col-md-12 jumbotron text-center p5">
	 	<div class="table-wrapper pb-4">
           @include("components.datatable.datatable", [
                    ...
                    "checkbox" => "disabled",
                    "thead" => [
                        "title" => ["No","Nama","IC No.","Ibu/Bapa","Edit/Delete"],
                        "class" => "th-md",
                        "icons" => "",
                    ]
                ])
	...
	<script type="text/javascript">
		...
		$(function(){
	        ...
	        var table = $('#users-table').DataTable({
	            processing: true,
	            serverSide: true,
	            ajax: '{{route('admin.student.datatable.index')}}',
	            pageLength: 5,
	            columns: [
	                { data: 'student_id', name: 'student_id' },
	                { data: 'name', name: 'name' , searchable: true},
	                { data: 'ic_number', name: 'ic_number' , searchable: true},
