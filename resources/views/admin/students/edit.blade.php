        ...
        <section class="section team-section">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-8 mb-4 mr-4">
                    <form method="post" action="{{route('admin.student.update',['student' => $record->student_id])}}">
                        {{ method_field('PUT') }}
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="md-form form-sm">
                                            <input type="text" id="name" name="name" class="form-control form-control-sm" value="{{$record->name ? $record->name : old('name')}}">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="md-form form-sm">
                                            <input type="text" id="icnumber" name="icnumber" class="form-control form-control-sm" value="{{$record->ic_number ? $record->ic_number : old('icnumber')}}">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="md-form form-sm">
                                            <input type="text" id="phoneNo" name="phoneNo" class="form-control form-control-sm" value="{{$record->phone_number ? $record->phone_number : old('phoneNo')}}">
                                        ...
                                        <div class="md-form form-sm">
                                            ...
                                            <select class="mdb-select colorful-select dropdown-primary" name="classroom" id="classroom" required>
                                                ...
                                                @foreach($classrooms as $class)
                                                    <option value="{{$class->class_id}}" {{$record->class_id == $class->class_id ? 'selected' : ''}}>{{$class->form}} {{$class->name}}</option>
                                                @endforeach
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="md-form form-sm">
                                            ...
                                            @else
                                                ...
                                                <label for="parent_ic" class="">Parent IC</label>
                                            @endif
                                        </div>
