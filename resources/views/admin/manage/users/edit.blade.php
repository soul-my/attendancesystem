        ...
        <section class="section team-section">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-8 mb-4">
                    <form method="post" action="{{route('admin.manage.users.update', ['user'=>$record->id])}}">
                        @csrf
                        {{ method_field('PUT') }}
                        <!--Card-->
                        <div class="card card-cascade cascading-admin-card user-card pb-5">
                            ...
                            <div class="admin-up d-flex justify-content-start">
                                ...
                                <div class="data">
                                    <h5 class="font-weight-bold dark-grey-text">Kemaskini Pengguna- <span class="text-muted">Sila pastikan semua ruangan diisi</span></h5>
                                </div>
                            </div>
                            <!--/.Card Data-->
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="md-form">
                                            <input type="text" id="name" name="name" class="form-control" required="" value="{{$record->name ? $record->name : old('name')}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="md-form">
                                            ...
                                            <input type="email" id="email" name="email" class="form-control" required="" value="{{$record->email ? $record->email :old('email')}}">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 text-right pt-5">
                                        ...
                                        <a href="{{route('admin.manage.users.show',['user'=>$record->id])}}"><button type="button" class="btn btn-flat grey lighten-3 btn-rounded waves-effect font-weight-bold dark-grey-text">Kembali</button></a>
                                    </div>  
